...
#pragma config(Motor,  mtr_S1_C1_1,     leftBack,      tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     rightBack,     tmotorTetrix, openLoop, encoder)
...
#pragma config(Motor,  mtr_S1_C3_2,     leftFront,     tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_1,     rightFront,    tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_2,     picollo,       tmotorTetrix, openLoop)
